...
`household_dynamics()` automatically imputes missing factor covariates via Bayesian data augmentation during MCMC. Simply pass your data with `NA` values in factor columns:
...
fit_missing <- household_dynamics(inputdata_missing, ~sex, ~age, SI,
                                  n_iteration = 50000, burnin = 10000, thinning = 10)
